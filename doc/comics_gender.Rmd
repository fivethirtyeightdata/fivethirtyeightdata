...
**Note as of 2020-07-18:** The entire `comic_charachters` dataset is available in the `fivethirtyeightdata` package. Instructions to download the `fivethirtyeightdata` package are given when you load the `fivethirtyeight` package. Alternately, you can run the following:
