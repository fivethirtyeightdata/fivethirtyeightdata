...
The goal of fivethirtyeightdata.test is to …

## Installation

You can install the released version of fivethirtyeightdata.test from
[CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("fivethirtyeightdata.test")
```
